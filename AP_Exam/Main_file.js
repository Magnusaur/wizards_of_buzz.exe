...
function mousePressed() { //A monster. But yea we could not make the mousePressed work properly, so we put up a long segment of code with the intention of turning the space of pictures from both "friends" and "suggested friends" into "buttons".
  if(mouseX > -98 && mouseX < -33 && mouseY > -120 && mouseY < -55) {
    friend[0].createProfile(); //Find description in the class-file
